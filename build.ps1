...
$global:Latest = @{
    Url32 = 'https://web.archive.org/web/20230314021530if_/https://www.nirsoft.net/utils/multimonitortool.zip'
    Url64 = 'https://web.archive.org/web/20230314021551if_/https://www.nirsoft.net/utils/multimonitortool-x64.zip'
    Version = $version
}
